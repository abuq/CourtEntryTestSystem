...
{ "ER_QUERY_TIMEOUT", 3024, "Query execution was interrupted, max_statement_time exceeded" },
...
{ "ER_SLAVE_CHANNEL_MUST_STOP", 3081, "This operation cannot be performed with a running replication threads; run STOP SLAVE FOR CHANNEL \'%s\' first" },
{ "ER_SLAVE_CHANNEL_NOT_RUNNING", 3082, "This operation requires a running replication threads; configure slave and run START SLAVE FOR CHANNEL \'%s\'" },
...
{ "ER_WARN_DEPRECATED_SQLMODE", 3090, "Setting sql mode \'%s\' is deprecated. It will be made read-only in a future release." },
...
{ "ER_KEY_BASED_ON_GENERATED_COLUMN", 3103, "Key/Index cannot be defined on a virtual generated column." },
...
{ "ER_GENERATED_COLUMN_REF_AUTO_INC", 3109, "Stored generated column \'%s\' cannot refer auto-increment column." },
...
{ "ER_CANT_USE_AUTO_POSITION_WITH_GTID_MODE_OFF", 3112, "The replication receiver thread for channel \'%s\' cannot start in AUTO_POSITION mode: this server uses @@GLOBAL.GTID_MODE = OFF." },
...
{ "ER_WARN_UNSUPPORTED_MAX_EXECUTION_TIME", 3125, "MAX_EXECUTION_TIME hint is supported by SELECT statements only" },
...
{ "ER_WARN_DEPRECATED_SQLMODE_UNSET", 3129, "Unsetting sql mode \'%s\' is deprecated. It will be made read-only in a future release." },
